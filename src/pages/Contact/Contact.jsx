...
const Contact = () => {
  ...
  return (
    <div className="bg-[#faeada] w-full sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl px-8 py-4">
        ...
        <div className="grid grid-cols">
          ...
          <div className="py-4">
            <p className="text-left">
              <span className="font-bold">Phone:</span> 123-456-7890 (fake number)
            </p>
            <p className="text-left">
              <span className="font-bold">Address:</span> 123 Fake Street, City, Country (fake address)
            </p>
          </div>
        </div>
