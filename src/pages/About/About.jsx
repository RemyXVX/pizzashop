          ...
          <div className="overflow-y-auto max-h-[500px] md:max-h-auto" style={{WebkitOverflowScrolling: 'touch'}}>
            <div className="mb-6 text-left text-sm md:text-base lg:text-xl">
              <div className="indent-8 pb-2">
                ...
                all started with a deep-rooted passion for pizza that had been
                passed down through generations. This passion ignited a fire
                within the hearts of our founders, inspiring them to embark on a
                journey to create the most delectable pizzas known to mankind.
              </div>
              <div className="indent-8 pb-2">
                With a long-standing tradition of pizza making, Pizzapaloz is not
                just a pizza shop; it is a sacred place where each pie is crafted
                with love and expertise. Our skilled artisans pour their hearts
                and souls into every aspect of pizza creation, from the selection
                of the finest ingredients to the delicate art of dough tossing.
              </div>
              <div className="indent-8 pb-2">
              ...
              <div className="indent-8 pb-2">
                ...
                you're sharing a meal with loved ones, bonding with friends over a
                cheesy slice, or simply savoring a moment of solitude with your
                favorite pie, Pizzapaloz is there to elevate your experience and
              ...
              <div className="indent-8 pb-2">
                ...
                invite you to join us on this mouthwatering adventure, as we serve
                up slices of happiness and share our love for pizza with the
                world.
              </div>
              <div className="indent-8 pb-2">
                ...
                selected to deliver the perfect balance of flavors, and where the
                pursuit of deliciousness knows no bounds. We welcome you to
                experience the joy, the passion, and the tradition of pizza making
                that defines Pizzapaloz. Prepare to be enchanted, for here, in our
                humble pizzeria, we create magic, one pie at a time.
              </div>
            </div>
          </div>
          <div>
